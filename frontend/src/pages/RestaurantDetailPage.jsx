...
const DEMO_REVIEWS = [
  { user: { name: 'Priya Sharma', photoURL: 'https://i.pravatar.cc/100?img=5' }, rating: 5, foodRating: 5, deliveryRating: 4, comment: 'Absolutely amazing! The food was perfectly cooked and arrived piping hot. Will definitely order again!', isVerified: true, createdAt: '2024-03-15' },
  ...
  { user: { name: 'Ananya Krishnan', photoURL: 'https://i.pravatar.cc/100?img=25' }, rating: 5, foodRating: 5, deliveryRating: 5, comment: 'Best food in Bangalore! The flavours are super authentic and the packaging is excellent. Highly recommend.', isVerified: false, createdAt: '2024-03-05' },
];
